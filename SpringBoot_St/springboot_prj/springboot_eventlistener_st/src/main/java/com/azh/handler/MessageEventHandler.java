package com.azh.handler;

import com.alibaba.fastjson.JSON;
import com.azh.common.StringMap;
...
public class MessageEventHandler {
    ...
    public void onEvent(SocketIOClient client, AckRequest request, StringMap data) {
        log.info("发来消息：" + JSON.toJSONString(data));
        //回发消息
